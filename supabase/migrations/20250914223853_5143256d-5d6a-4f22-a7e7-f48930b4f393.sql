-- Fix Tom's password and Anna's account issues
...
-- Fix Anna's PLN balance to 30,000 (the pending 27,000 will be failed and added back)
...
-- Add a new transaction showing the reversal/credit back to Anna's account
